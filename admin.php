          ...
          <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                  <h4 class="modal-title">Добавление рейса</h4>
                </div>
                <div class="modal-body">
                    <form>
                      <div class="form-group" style="text-align:left">
                        <label >Номер рейса</label>
                        <input type="text" id="num" placeholder="#" class="form-control">
                        <label>Дата отправки</label>
                        <input type="date" id="d_dep" class="form-control">
                        <label>Дата прибытия</label>
                        <input type="date" id="d_ari" class="form-control">
                        <label>Время отправки</label>
                        <input type="time" id="time" class="form-control">
                        <label>Кол-во мест</label>
                        <input type="number" id="places" class="form-control">
                        <label>Место отправки</label>
                        <input type="text" id="dep" class="form-control" placeholder="Moscow">
                        <label>Место прибытия</label>
                        <input type="text" id="ari" class="form-control" placeholder="New York">
                      </div>
                    </form>
                </div>
